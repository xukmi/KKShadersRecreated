Shader "xukmi/HairFront"
{
	Properties
	{
		...
		_SpeclarHeight ("Speclar Height", Range(0, 1)) = 0.985
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "KKHairInput.cginc"
			#include "KKHairDiffuse.cginc"
		...
		Pass
		{
			...
			#define HAIR_FRONT
			#include "KKHairVertFrag.cginc" //Vert Frag here
